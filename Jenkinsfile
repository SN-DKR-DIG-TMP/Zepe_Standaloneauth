pipeline{
    ...
    stages{
            ...
            stage('SCM Checkout') {
              steps {
                 git(branch: 'main', credentialsId: 'gitlab',  url:'${GITLAB_URL}/zepe/standaloneauth')
              }
         }
        ...
        stage('Upload Jar to nexus'){
            steps{
                ...
                sh "Skip Nexus uploading beacause credentialsId not good."
            }
        }
